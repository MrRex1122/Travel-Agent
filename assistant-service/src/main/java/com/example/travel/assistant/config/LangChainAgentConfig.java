...
public class LangChainAgentConfig {
    ...
    public ChatLanguageModel chatLanguageModel(
            ...
            @Value("${assistant.ollama.model:llama3.1}") String model,
            @Value("${assistant.ollama.request-timeout-ms:60000}") long timeoutMs,
            @Value("${assistant.ollama.temperature:0.2}") double temperature
    ) {
    ...
    @Bean
    public TravelAssistantAgent travelAssistantAgent(ChatLanguageModel model, BookingTools bookingTools) {
